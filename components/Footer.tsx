            ...
            <ul className="flex flex-col gap-4 text-sm text-stone-500">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex gap-4 group hover:text-primary transition"
                >
                  <MapPin size={18} className="text-primary mt-1 shrink-0 group-hover:scale-110 transition" />
                  <div>
                    <p className="text-stone-700 font-medium group-hover:underline">
                      Melesio Morales #2-A
                    </p>
              ...
              <li className="flex gap-4 items-center">
                ...
                <a href="tel:+525525608725" className="hover:text-primary transition">
                  (+52) 55 2560 8725
                </a>
              </li>
